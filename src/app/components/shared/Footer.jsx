      ...
      <div className="footer pt-20  footer-horizontal footer-center  text-primary-content p-10">
        <div className="border-b w-full container mx-auto border-b-gray-500 pb-6">
          <aside>
            ...
            <p>
              Your personal space to stay connected with friends. Track
              interactions, nurture relationships, and never lose touch with the
        ...
        <div className="flex flex-col md:flex-row items-center justify-between w-full container mx-auto ">
